...
abstract class BaseTest extends TestCase
{
    ...
    public function tearDown(): void
    {
        ...
        $this->db()->getDriver(Database::WRITE)->disconnect();
        $this->db()->getDriver(Database::READ)->disconnect();
    }
    ...
    /**
     * @return Driver|\MakiseCo\Database\Driver\MakisePostgres\MakisePostgresDriver
     */
